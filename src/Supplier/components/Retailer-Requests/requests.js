                    ...
                    <Modal.Body>
                      <form>
                        <label>
                          ...
                          >
                            1 {t("supplier.retailer_request.invoice1")}
                          </span>
                        </label>
                        ...
                        <label>
                          ...
                          <span
                            ...
                            style={{ padding: "10px 20px" }}
                          >
                            2 {t("supplier.retailer_request.invoice2")}
                          </span>
                        </label>
                        <label>
                          <input
                          ...
                          <span
                            ...
                            style={{ padding: "10px 20px" }}
                          >
                            3 {t("supplier.retailer_request.invoice3")}
                          </span>
                        </label>
                        ...
                        <label>
                          ...
                          <span
                            ...
                            style={{ padding: "10px 20px" }}
                          >
                           4 {t("supplier.retailer_request.invoice4")}
                          </span>
                        </label>
                        ...
                        <label>
                          ...
                          <span
                            ...
                            style={{ padding: "10px 20px" }}
                          >
                           5 {t("supplier.retailer_request.invoice5")}
                          </span>
                        </label>
                      </form>
                    </Modal.Body>
